    ...
    return {
        ...
        templateUrl: function (tElement, tAttrs) {
            if (tAttrs.templateUrl === undefined) {
                return "gantt/template/gantt.tmpl.html";
            } else {
        ...
        controller: ['$scope', '$element', function ($scope, $element) {
            ...
            $element.bind('click', function (e) {
                $scope.$apply(function() {
                    ...
                    //Maestral - allow click if task has been moved, but is in copy mode now. Otherwise task selction is prevented.
                    //if (!taskHasBeenChanged || !$scope.allowTaskMoving) {
